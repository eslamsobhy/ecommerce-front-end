...
const Mobile = () => {
    ...
    <div  className="p-5 m-auto w-1/2 flex items-center"><Link  className="flex items-center" to={"./Category"}>         <span className="mr-2 uppercase font-bold tracking-wider">Apple</span> < FaApple size={40} /> </Link></div>
    <div  className="p-5 m-auto w-1/2 flex items-center"><Link  className="flex items-center" to={"./Category"}>         <span className="mr-2 uppercase font-bold tracking-wider">SAMSUNG</span> < SiSamsung size={50}  /> </Link></div>
    ...
    <div  className="p-5 m-auto w-1/2 flex items-center"><Link  className="flex items-center" to={"./Category"}>         <span className="mr-2 uppercase font-bold tracking-wider">HUAWEI</span> < SiHuawei size={40} /> </Link></div>
    ...
    <div  className="p-5 m w-1/2 flex items-center"><Link  className="flex items-center" to={"./Category"}>         <span className="mr-2 uppercase font-bold tracking-wider">XIAOMI</span> < SiXiaomi size={35} /> </Link></div>
    </div>
       </> );
}
